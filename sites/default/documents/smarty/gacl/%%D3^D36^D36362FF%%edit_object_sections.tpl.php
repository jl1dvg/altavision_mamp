<?php /* Smarty version 2.6.31, created on 2019-10-09 18:53:57
         compiled from phpgacl/edit_object_sections.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'phpgacl/edit_object_sections.tpl', 25, false),array('modifier', 'upper', 'phpgacl/edit_object_sections.tpl', 44, false),)), $this); ?>
      ...
      <table cellpadding="2" cellspacing="2" border="2" width="100%">
        <tbody>
          <tr class="pager">
            <td colspan="11">
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "phpgacl/pager.tpl", 'smarty_include_vars' => array('pager_data' => $this->_tpl_vars['paging_data'],'link' => "?object_type=".($this->_tpl_vars['object_type_escaped'])."&")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
            </td>
...
?>
          <tr valign="top" align="center">
            <td>
              <?php echo ((is_array($_tmp=$this->_tpl_vars['sections'][$this->_sections['x']['index']]['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>

              <input type="hidden" name="sections[<?php echo $this->_tpl_vars['sections'][$this->_sections['x']['index']]['id']; ?>
][]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['sections'][$this->_sections['x']['index']]['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
">
            </td>
            <td><input type="text" size="10" name="sections[<?php echo $this->_tpl_vars['sections'][$this->_sections['x']['index']]['id']; ?>
][]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['sections'][$this->_sections['x']['index']]['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></td>
            <td><input type="text" size="10" name="sections[<?php echo $this->_tpl_vars['sections'][$this->_sections['x']['index']]['id']; ?>
][]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['sections'][$this->_sections['x']['index']]['order'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></td>
            <td><input type="text" size="40" name="sections[<?php echo $this->_tpl_vars['sections'][$this->_sections['x']['index']]['id']; ?>
][]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['sections'][$this->_sections['x']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></td>
            <td>&nbsp;</td>
            <td><input type="checkbox" class="checkbox" name="delete_sections[]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['sections'][$this->_sections['x']['index']]['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></td>
          </tr>
<?php endfor; endif; ?>
          <tr class="pager">
...
unset($_smarty_tpl_vars);
 ?>
          ...
          <tr align="center">
            <td colspan="6"><b>Add <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['object_type'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
 Sections</b></td>
          </tr>
          <tr>
            <th>ID</th>
...
?>
          <tr valign="top" align="center">
            <td>N/A</td>
            <td><input type="text" size="10" name="new_sections[<?php echo ((is_array($_tmp=$this->_tpl_vars['new_sections'][$this->_sections['y']['index']]['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
][]" value=""></td>
            <td><input type="text" size="10" name="new_sections[<?php echo ((is_array($_tmp=$this->_tpl_vars['new_sections'][$this->_sections['y']['index']]['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
][]" value=""></td>
            <td><input type="text" size="40" name="new_sections[<?php echo ((is_array($_tmp=$this->_tpl_vars['new_sections'][$this->_sections['y']['index']]['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
][]" value=""></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
