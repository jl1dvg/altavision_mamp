   ...
   if (catid == '2') { // In Office
    ...
    f.form_apptstatus.style.display = '';
     ...
     if (s.selectedIndex >= 0) {
         ...
         if (catid == '15') { // Quirurgico
             style_datos_cirugia.display = '';
             style_cirugia.display = '';
             f.form_apptqx.style.display = '';
             style_cirugiaOI.display = '';
             f.form_apptqxOI.style.display = '';
             style_LIOOD.display = '';
             ...
             f.form_apptqx.style.display = 'none';
             style_cirugiaOI.display = 'none';
             f.form_apptqxOI.style.display = 'none';
 ...
 <tr>
  ...
  <td colspan='4' nowrap>
   <input class='input-sm' type='text' size='40' name='form_comments' style='width:100%' value='<?php echo attr($hometext); ?>' title='<?php echo xla('Optional information about this event');?>' />
    ...
    <tr>
        <td nowrap>
            <span id='title_examenes' style='display:none'><b><?php echo xlt('Exámenes'); ?>:</b></span>
        </td>
        <td colspan='4' nowrap>
            <input class='input-sm' type='text' size='40' name='form_examenes' style='width:100%' value="<?php
...
"
    ...
    <tr>
        <td colspan="5" nowrap>
            <span id='title_datos_cirugia' style='display:none'><b><?php echo xlt('Datos para Cirugía'); ?>:</b></span>
        </td>
    </tr>
    <tr>
        <td nowrap>
        ...
        <td colspan="2" nowrap>
            <input class='input-sm' type='text' size='60' name='form_apptqx' style='width:100%' value="<?php
            ...
            if ($row['pc_apptqx'] == null) {
                echo Cirugia_planificada($patientid, "od");
            }
            else {
                echo text($row['pc_apptqx']);
            }
            ?>
"
        ...
        <td colspan="1" nowrap>
            <input class='input-sm' type='text' size='20' name='form_lioOD' style='width:100%' value='<?php
            if ($row['pc_LIOOD'] == null) {
                if ($result2['LIOOD']) {
                    echo attr($result2['LIOOD']);
                }
            }
            else {
                echo text($row['pc_LIOOD']);
            }
            ?>' title='<?php echo xla('Optional information about this event');?>' />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="2" nowrap>
            <input class='input-sm' type='text' size='60' name='form_apptqxOI' style='width:100%' value="<?php

            if ($row['pc_apptqxOI'] == null) {
                echo Cirugia_planificada($patientid, "oi");
            }
            else {
                echo text($row['pc_apptqxOI']);
            }
        ...
        <td colspan="1" nowrap>
            <input class='input-sm' type='text' size='20' name='form_lioOI' style='width:100%' value='<?php
            if ($row['pc_LIOOI'] == null) {
                if ($result2['LIOOI']) {
                    echo attr($result2['LIOOI']);
                }
            }
            else {
                echo text($row['pc_LIOOI']);
            }
            ?>' title='<?php echo xla('Optional information about this event');?>' />
        </td>
    </tr>
