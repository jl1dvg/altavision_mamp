...
<div>
    <a href='<?php echo $web_root . "/controller.php?document&list&patient_id=" . $pid; ?>' class='css_button' onclick='top.restoreSession();'><span><?php echo xl('Cargar imágenes') ?></span></a>
