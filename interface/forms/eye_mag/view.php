                          ...
                          <dl class="building_blocks" id="building_blocks" name="building_blocks">
                              ...
                              <?php
                                ...
                                */
                                ...
                                $TODO_data = sqlStatement($query, array("cirugia_propuesta_".$providerID));
                              if (sqlNumRows($TODO_data) < '1') {
                                  // Provider list is not created yet, or was deleted.
                                  // Create it fom defaults...
                                  $query = "INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `activity`) VALUES ('lists', ?, ?, '0', '1', '0', '', '', '', '0')";
...
?>
                            <dt class="borderShadow">
                                ...
                                <a href="<?php echo $GLOBALS['webroot']; ?>/interface/super/edit_list.php?list_id=cirugia_propuesta_<?php echo attr($providerID); ?>" target="RTop"
                                   title="<?php echo xla('Click here to Edit this Doctor\'s Plan options'); ?>"
                                   name="provider_todo" style="color:black;font-weight:600;"><i class="fa fa-pencil fa-fw"></i> </a>
                            </dt>
                            <dd>
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="3" style="padding-left:20px;padding-top:4px;">
                                <textarea id="Plan<?php echo $counter; ?>" name="PLANQX[]" style="width: 440px;height: 44px;"><?php if ($foundQX < (empty($PLANQX_arr) ? 0 : count($PLANQX_arr))) {
                                        echo $PLANQX_arr[count($PLANQX_arr)-1]['ORDER_DETAILS']; } ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                    <td colspan="2" style="padding-left:20px;padding-top:4px;"><b>Resultado Esperado:</b></td>
                                    <td colspan="1" style="padding-left:20px;padding-top:4px;"><b>LIO:</b></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="padding-left:20px;padding-top:4px;">
                              <textarea id="PropositoOD" name="PROPOSITOOD" style="width: 250px;height: 44px;"><?php echo text($PROPOSITOOD); ?></textarea>
                                        </td>
                                        <td colspan="1" style="padding-left:20px;padding-top:4px;">
                              <textarea id="LioOD" name="LIOOD" style="height: 44px;"><?php echo text($LIOOD); ?></textarea>
                                        </td>
                                    </tr>
                                </table>
                            </dd>
                          ...
                          <dd>
                              <table>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        <td colspan="3" style="padding-left:20px;padding-top:4px;">
                                <textarea id="Plan<?php echo $counter; ?>" name="PLANQXOI[]" style="width: 440px;height: 44px;"><?php if ($foundQXOI < (empty($PLANQXOI_arr) ? 0 : count($PLANQXOI_arr))) {
                                        echo $PLANQXOI_arr[count($PLANQXOI_arr)-1]['ORDER_DETAILS']; } ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                    <td colspan="2" style="padding-left:20px;padding-top:4px;"><b>Resultado Esperado:</b></td>
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding-left:20px;padding-top:4px;">
                              <textarea id="PropositoOI" name="PROPOSITOOI" style="width: 250px;height: 44px;"><?php echo text($PROPOSITOOI); ?></textarea>
                                        </td>
                                        <td colspan="1" style="padding-left:20px;padding-top:4px;">
                              <textarea id="LioOI" name="LIOOI" style="height: 44px;"><?php echo text($LIOOI); ?></textarea>
                                        </td>
